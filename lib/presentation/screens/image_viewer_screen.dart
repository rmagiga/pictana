  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: imagesAsync.when(
          ...
          return Stack(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _InteractiveImageView(image: image);
                  },
                ),
              ),
              ...
              AnimatedPositioned(
                ...
                top: _isOverlayVisible ? 0 : -kToolbarHeight - MediaQuery.paddingOf(context).top,
                left: 0,
                right: 0,
                child: Container(
              ...
              AnimatedPositioned(
                duration: const Duration(milliseconds: 200),
                bottom: _isOverlayVisible ? MediaQuery.paddingOf(context).bottom + 16 : -50,
                left: 0,
                right: 0,
                child: IgnorePointer(
                  child: Center(
        ...
        error: (e, st) => Center(child: Text('エラー: $e', style: const TextStyle(color: Colors.white))),
      ),
    );
  }
}
...
class _InteractiveImageView extends ConsumerStatefulWidget {
  const _InteractiveImageView({required this.image});

  final ImageEntry image;

  @override
  ConsumerState<_InteractiveImageView> createState() => _InteractiveImageViewState();
}
      ...
      child: InteractiveViewer(
        ...
        child: Center(
          child: bytesAsync.when(
            ...
            // 読み込み中は低解像度のサムネイルを表示する（要改善: サムネイルProviderを利用）
