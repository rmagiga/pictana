...
@override
int get hashCode => Object.hash(runtimeType,query,selectedMimeType,isSearchBarExpanded);

@override
String toString() {
  return 'SearchFilterState(query: $query, selectedMimeType: $selectedMimeType, isSearchBarExpanded: $isSearchBarExpanded)';
}
...
@useResult
$Res call({
 String query, ImageMimeType? selectedMimeType, bool isSearchBarExpanded
});
...
/// Create a copy of SearchFilterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? query = null,Object? selectedMimeType = freezed,Object? isSearchBarExpanded = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String query,  ImageMimeType? selectedMimeType,  bool isSearchBarExpanded)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchFilterState() when $default != null:
return $default(_that.query,_that.selectedMimeType,_that.isSearchBarExpanded);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String query,  ImageMimeType? selectedMimeType,  bool isSearchBarExpanded)  $default,) {final _that = this;
switch (_that) {
case _SearchFilterState():
return $default(_that.query,_that.selectedMimeType,_that.isSearchBarExpanded);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String query,  ImageMimeType? selectedMimeType,  bool isSearchBarExpanded)?  $default,) {final _that = this;
switch (_that) {
case _SearchFilterState() when $default != null:
return $default(_that.query,_that.selectedMimeType,_that.isSearchBarExpanded);case _:
  return null;
...
class _SearchFilterState implements SearchFilterState {
  const _SearchFilterState({this.query = '', this.selectedMimeType, this.isSearchBarExpanded = false});
...
/// Create a copy of SearchFilterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? query = null,Object? selectedMimeType = freezed,Object? isSearchBarExpanded = null,}) {
